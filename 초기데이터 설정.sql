...
(16, '김지원자', 'kim', '1234', '비회원', null, null);


LOCK TABLES `user_club` WRITE;
/*!40000 ALTER TABLE `user_club` DISABLE KEYS */;
INSERT INTO `user_club` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5),(6,6,4),(7,6,3),(8,7,2),(9,8,2),(10,8,6),(11,9,5),(12,10,7),(13, 11, 6),(14, 12, 7),(15, 14, 7),(16, 15, 7);
...
INSERT INTO board_name (id,board_name) VALUES
 ...
 INSERT INTO board (id, board_name_id, title, content, date, club_id, start_date, end_date) VALUES
  ...
  (14, 3, '멋사 공지사항2', '공지사항 알립니다.', '2020-06-16', 2, null, null),
  (15, 3, '멋사 공지사항3', '공지사항 알립니다.', '2020-06-17', 2, null, null),
  (16, 3, '멋사 공지사항4', '공지사항 알립니다.', '2020-06-18', 2, null, null),
  (17, 4, '멋사 회의록2', '멋사 회의록입니다.', '2020-06-19', 2, null, null),
  (18, 4, '멋사 회의록3', '멋사 회의록입니다.', '2020-06-16', 2, null, null),
  (19, 4, '멋사 회의록4', '멋사 회의록입니다.', '2020-06-20', 2, null, null),
  (20, 4, '멋사 회의록5', '멋사 회의록입니다.', '2020-06-21', 2, null, null),
  (21, 1, '홍보3', '멋사 홍보', '2020-06-19', 2, null, null),
  (22, 1, '홍보4', '멋사 홍보4', '2020-06-20', 2, null, null),
  (23, 1, '홍보5', '멋사 홍보5', '2020-06-21', 2, null, null),
  (24, 1, '홍보6', '멋사 홍보6', '2020-06-22', 2, null, null);
  ...
  INSERT INTO `softwarecapstion`.`apply_a` (`id`,`apply_q_id`, `content`, `user_id`, `club_id`) VALUES ('1','1', '심심해서요', '13', '2');
  INSERT INTO `softwarecapstion`.`apply_a` (`id`,`apply_q_id`, `content`, `user_id`, `club_id`) VALUES ('2','2', '56', '13', '2');
  INSERT INTO `softwarecapstion`.`apply_a` (`id`,`apply_q_id`, `content`, `user_id`, `club_id`) VALUES ('3','3', '죽지못해 산다', '13', '2');
INSERT INTO `softwarecapstion`.`apply_a` (`id`,`apply_q_id`, `content`, `user_id`, `club_id`) VALUES ('4','1', 'ㄲ', '16', '2');
  INSERT INTO `softwarecapstion`.`apply_a` (`id`,`apply_q_id`, `content`, `user_id`, `club_id`) VALUES ('5','2', 'ㄸ', '16', '2');
  INSERT INTO `softwarecapstion`.`apply_a` (`id`,`apply_q_id`, `content`, `user_id`, `club_id`) VALUES ('6','3', 'ㅉ 산다', '16', '2');
