		...
		<div class="row">
			<div class="col-md-12 animate-box">
				...
				<div>
					<div class="row">
						<div class="col-md-12 animate-box">
							<h2 class="fh5co-uppercase-heading-sm text-center">Form 관리</h2>
							...
							<form action="#" method="post">
								...
								<div class="col-md-7">
									<div class="form-group">
										...
										<select class="form-control input-lg" id="department">
								...
								<div>
									...
									<div class="col-md-2">
										<a href="#"
											style="color: #ff0000; vertical-align: middle; font-size: 20px">x</a>
									</div>
								</div>
								<div class="col-md-12">
