...
<div id="fh5co-main">
											...
											<c:forEach var="account" items="${ accounts }">
												<c:if test="${user_club_id eq account.club_id }">
													<tr>
														...
														<td><a href="${R}club_admin/delete?id=${account.id}"
	...
	<div class="col-md-2 col-md-pull-7" id="fh5co-sidebar">
		<ul class="attendance_check-list hor_1">
			...
			<li><a href="${R}club_admin/account?club_id=${user_club_id}">회계
					관리</a></li>
			...
			<li><a href="${R}club_admin/acceptance?club_id=${user_club_id}">회원
					관리</a></li>
			<li><a
				href="${R}club_admin/apply_q_form?club_id=${user_club_id}">지원 폼</a></li>
		</ul>
	</div>
	<!-- sidebar 끝 -->
