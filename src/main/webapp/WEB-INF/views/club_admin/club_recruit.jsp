				...
				<div class="col-md-9 col-md-push-3" id="fh5co-content">
					<div class="row">
						<div style="margin-bottom: 20px">
							<h4 style="color: #CCCCCC; text-align : center; ">모집 게시판</h4>
						</div>
						<div>
							<div style="margin-left: 50px">
								<table class="table table-striped " style="width: 650px">
									...
									<c:forEach var="board" items="${boards}">
										<tr>
											<td><a
												href="r_content?club_id=${board.club_id}&id=${board.id}">${board.title}</a></td>
											<td style="text-align: center; width: 200px;"><fmt:formatDate
													pattern="yyyy-MM-dd" value="${ board.date }" /></td>
											<sec:authorize access="hasRole('ROLE_ClubAdmin')">
												<td style="width: 50px"><a onclick="return post_del('r_delete?id=${board.id}');"
								...
								<div class="row">
									<div class="col-md-12">
										<sec:authorize access="hasRole('ROLE_ClubAdmin')">
											<a href="r_create?club_id=${club_id}"
