                     ...
                     <div style="margin-left: 50px">
                        <table class="table table-striped " style="width: 650px">
                           ...
                           <c:forEach var="board" items="${boards}">
                              <tr>
                                 <td><a href="r_content?club_id=${board.club_id}&id=${board.id}">${board.title}</a></td>
                                 <td style="text-align: center;  width: 200px;"><fmt:formatDate pattern="yyyy-MM-dd" value="${ board.date }" /></td>
                                  <sec:authorize access="hasRole('ROLE_ClubAdmin')">
                                  <td style="width: 50px"><a href="r_delete?id=${board.id}" style="color: #ff0000">x</a></td>
                                  </sec:authorize>
                              </tr>
                           </c:forEach>
                        </table>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                           <sec:authorize access="hasRole('ROLE_ClubAdmin')">
                                <a href="r_create?club_id=${club_id}" class="btn btn-primary btn-lg" id="l_search_term_btn" style="float:right;">작성</a>
                            </sec:authorize>   
                           </div>
                        </div>
                     </div>
