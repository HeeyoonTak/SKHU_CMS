						...
						<div class="col-md-12">
							<div style="margin-left: 50px">
								<table class="table table-striped " >
									...
									<tr style="text-align: center">
										<!-- <td>모집 기간</td> -->
										<td>모집 기간 : <fmt:formatDate pattern="yyyy-MM-dd" value="${ board.start_date }" /> ~ <fmt:formatDate pattern="yyyy-MM-dd" value="${ board.end_date }" /></td>
									</tr>
									
								</table>
								<div class="row">
									<div class="col-md-12">
										<a class="btn btn-primary btn-lg" id="l_search_term_btn" style="float:right;" href="recruit">목록</a>
										<a class="btn btn-primary btn-lg" id="l_search_term_btn" style="float:right;" href="">작성</a>
									</div>
								</div>
							</div>
						</div>
